...
const APP_URL = process.env.NEXT_PUBLIC_APORTO_APP_URL ?? "https://app.aporto.tech";
...
export default function SkillPricingPage() {
    ...
    useEffect(() => {
        ...
        async function loadPricing() {
            ...
            setError(null);
            try {
                const res = await fetch(`${APP_URL}/api/skills/pricing`, { cache: "no-store" });
    ...
    return (
        <div className={styles.container}>
            <header className={styles.header}>
                <div>
                    <h1>Skill Pricing</h1>
                    <p>Live pricing for Aporto skills. Prices are listed as starting rates and update as skills and providers change.</p>
                </div>
